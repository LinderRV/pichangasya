...
$(document).ready(function () {
    ...
    let TablaIngresos = $('#tablaIngresos').DataTable({
        processing: true,
        serverSide: false,
        responsive: true,
        destroy: true,
        ...
        ajax: {
            url: "{{ route('admin.reportes.ingresos.lista') }}",
            type: "GET",
            data: filtros,
            dataSrc: "data"
        },
    ...
    $('#btnExportar').on('click', function () {
        window.location.href = "{{ route('admin.reportes.ingresos.exportar') }}?" + $.param(filtros());
    });
